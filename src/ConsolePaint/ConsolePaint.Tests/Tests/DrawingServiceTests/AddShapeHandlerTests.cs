...
namespace ConsolePaint.Tests.Tests.DrawingServiceTests
{
    public class AddShapeHandlerTests
    {
        ...
        public void AddShape(string shapeName, string shapeType, int x, int y, int width, int height, char fillCaharacter)
        {
            char borderChar = '#';
            var shape = new Rectangle(width, height, borderChar, x, y, shapeName, fillCaharacter);
